    ...
    return (
      <IonPage>
        ...
        <IonContent fullscreen>
                    ...
                    this.groupedTransactions[title].map(transaction => (
                      <IonItemSliding key={transaction.id}>
                        ...
                        <IonItem routerLink={`/transactions/${transaction.category.type}/${transaction.id}`}>
                          <IonIcon slot={'start'}
                                   icon={transaction.category.ionIcon}/>
                          <IonLabel>
                      ...
                      {(() => {
                        ...
                        return (
                          <>
                            ...
                            <IonText color={total >= 0 ? 'success' : 'danger'}>
          ...
          <IonInfiniteScroll threshold="100px" disabled={this.disableInfiniteScroll}
          ...
          <IonFab vertical="bottom" horizontal="end" slot="fixed" style={{ margin: 10 }}>
            ...
            <IonFabList side="top">
              <IonFabButton color={'danger'}
                            routerLink={'/transactions/expense/add'}>
                <IonIcon icon={remove}/>
              </IonFabButton>
              <IonFabButton color={'success'}
                            routerLink={'/transactions/income/add'}>
                <IonIcon icon={add}/>
              </IonFabButton>
            </IonFabList>
          </IonFab>
